...
func DefaultModels() []Model {
	...
	return []Model{
		...
		{Name: "models/gemini-3.5-flash", SupportedGenerationMethods: chatMethods},
		...
		{Name: "models/gemini-3.1-pro-preview-customtools", SupportedGenerationMethods: chatMethods},
