...
func (s *SettingService) buildAuthSourceDefaultUpdates(ctx context.Context, settings *AuthSourceDefaultSettings) (map[string]string, error) {
	...
	updates := make(map[string]string, 16)
...
func (s *SettingService) parseSettings(settings map[string]string) *SystemSettings {
	...
	// WeChat Connect settings (read directly from DB settings map)
	result.WeChatConnectEnabled = settings[SettingKeyWeChatConnectEnabled] == "true"
	result.WeChatConnectAppID = settings[SettingKeyWeChatConnectAppID]
	result.WeChatConnectAppSecret = settings[SettingKeyWeChatConnectAppSecret]
	result.WeChatConnectAppSecretConfigured = settings[SettingKeyWeChatConnectAppSecret] != ""
	result.WeChatConnectOpenAppID = settings[SettingKeyWeChatConnectOpenAppID]
	result.WeChatConnectOpenAppSecret = settings[SettingKeyWeChatConnectOpenAppSecret]
	result.WeChatConnectOpenAppSecretConfigured = settings[SettingKeyWeChatConnectOpenAppSecret] != ""
	result.WeChatConnectMPAppID = settings[SettingKeyWeChatConnectMPAppID]
	result.WeChatConnectMPAppSecret = settings[SettingKeyWeChatConnectMPAppSecret]
	result.WeChatConnectMPAppSecretConfigured = settings[SettingKeyWeChatConnectMPAppSecret] != ""
	result.WeChatConnectMobileAppID = settings[SettingKeyWeChatConnectMobileAppID]
	result.WeChatConnectMobileAppSecret = settings[SettingKeyWeChatConnectMobileAppSecret]
	result.WeChatConnectMobileAppSecretConfigured = settings[SettingKeyWeChatConnectMobileAppSecret] != ""
	result.WeChatConnectOpenEnabled = settings[SettingKeyWeChatConnectOpenEnabled] == "true"
	result.WeChatConnectMPEnabled = settings[SettingKeyWeChatConnectMPEnabled] == "true"
	result.WeChatConnectMobileEnabled = settings[SettingKeyWeChatConnectMobileEnabled] == "true"
	result.WeChatConnectMode = settings[SettingKeyWeChatConnectMode]
	result.WeChatConnectScopes = settings[SettingKeyWeChatConnectScopes]
	result.WeChatConnectRedirectURL = settings[SettingKeyWeChatConnectRedirectURL]
	result.WeChatConnectFrontendRedirectURL = settings[SettingKeyWeChatConnectFrontendRedirectURL]
